...
import { useCopilotChat, useCopilotAction, CatchAllActionRenderProps, CopilotKit } from "@copilotkit/react-core";
...
export default function CopilotKitPage() {
  return (
    ...
    <CopilotKit publicApiKey={process.env.NEXT_PUBLIC_COPILOT_API_KEY as string}>
      <YourMainContent />
      <CopilotSidebar
